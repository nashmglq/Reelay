...
const {generateImage, generateScript, newChat, getListViewChat, searchChat, getDetailChat, deleteChat, updateChat, historyChat, historyImage} = require("../controller/userGeneration")
...
route.get("/get-prev-images/:id", authCheck, historyImage)
